...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-auto items-center justify-center rounded-xl bg-black/20 p-1.5 text-muted-foreground border border-white/5',
      className,
    )}
    {...props}
  />
